...
namespace Enigma.D3
{
    ...
    {
        public const int SizeOf = 0xB360; // 2.4.0.34940
        ...
        [ArraySize(6)]
        public ActiveSkillSavedData[] x12C4_ActiveSkillSavedData { get { return Read<ActiveSkillSavedData>(0x12C4, 6); } }
        [ArraySize(4)]
        public int[] x1324_PassivePowerSnoIds { get { return Read<int>(0x1324, 4); } }
        ...
        public long x9180_HeroId { get { return Read<long>(0x9180 + 0xEB8); } } //2.4.0.34940
        public string x9188_HeroName { get { return ReadString(0x9188 + 0xEB8, 49); } } //2.4.0.34940
        ...
        public int x963C_ActorSnoId { get { return Read<int>(0x9638 + 0xEC0); } }   //2.4.0.34940
        public float x9640_LifePercentage { get { return Read<float>(0x963C + 0xEC0); } }   //2.4.0.34940
        public int x9644_LevelAreaSnoId { get { return Read<int>(0x9640 + 0xEC0); } }   //2.4.0.34940
        public int x9648_LevelAreaSnoId { get { return Read<int>(0x9644 + 0xEC0); } }   //2.4.0.34940
        public int x964C_HeroClass { get { return Read<int>(0x9648 + 0xEC0); } }    //2.4.0.34940
        public int x9650_Level { get { return Read<int>(0x964C + 0xEC0); } }    //2.4.0.34940
        public int x9654_AltLevel { get { return Read<int>(0x9650 + 0xEC0); } } //2.4.0.34940
        ...
        public int xA0E0_PowerUse { get { return Read<int>(0xB030); } } //2.4.0.34940
        public int xA0E4_PowerUse { get { return Read<int>(0xB034); } } //2.4.0.34940
        public int xA0E8_PowerUse { get { return Read<int>(0xB038); } } //2.4.0.34940
        public int _xA0EC { get { return Read<int>(0xA0EC); } }
        public int _xA0F0 { get { return Read<int>(0xA0F0); } }
        public int xA0F4_PowerCast { get { return Read<int>(0xB044); } }    //2.4.0.34940
        ...
        public double _xA11C { get { return Read<double>(0xA19C); } } // Test what this is!
        public int _xA120 { get { return Read<int>(0xA1A0); } } 
        ...
        public int xA150_Power { get { return Read<int>(0xA1D0); } } // Used at least for Walk.
        public int xA154_Power { get { return Read<int>(0xA1D4); } } // Used at least for Walk.
        ...
        public class PlayerSavedData : MemoryObject
        {
            ...
            #endregion
            [ArraySize(6)]
            public ActiveSkillSavedData[] x1218_ActiveSkillSavedData { get { return Read<ActiveSkillSavedData>(0x1220, 6); } }
            [ArraySize(4)]
            public int[] x1278_PassivePowerSnoIds { get { return Read<int>(0x1284, 4); } }
    ...
    {
        public static PlayerData Local { get { return Engine.TryGet(engine => Storage.Instance.x12C_Ptr_PlayerDataManager.Dereference().x0038_Items[Player.Instance.x00000_LocalDataIndex]); } }
        ...
        {
            return Read<long>((24 * (int)type) + 0x8D20); // 2.4.0.34940
        }
